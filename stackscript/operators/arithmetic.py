...
from stackscript.values import IntValue, FloatValue, BoolValue
from stackscript.exceptions import ScriptOperandError

from stackscript.operators.defines import Operator, Operand
from stackscript.operators.overloading import ophandler_typed, ophandler_permute, ophandler_untyped
...
def operator_invert(ctx, a) -> Iterable[DataValue]:
